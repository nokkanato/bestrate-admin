<template>
    <v-content>
      <!-- Desktop -->
        <!-- navbar -->
        <v-layout row wrap class="navbar-md">
            <v-flex xs2>
                <!-- logo -->
                  <img style="margin-top:15px; margin-left:10px;" height="55px" width="" src="~@/assets/logo.png" />
            </v-flex>
            <v-flex xs2></v-flex>
            <v-flex xs2>
                <p @click="changeState('Branches')" class="navbar-font underline">Branches</p>
            </v-flex>
            <v-flex xs2>
                <p @click="changeState('Currencies')" class="navbar-font underline">Currencies</p>
            </v-flex>
            <v-flex xs4>
...
<script>
import Branches from '@/components/md/Branches'
import Currencies from '@/components/md/Currency'
